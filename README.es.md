# 📖 md2kindle (MangaDex to Kindle)
 ...
 Un pipeline de automatización para descargar manga desde [MangaDex](https://mangadex.org) y convertirlo a formatos optimizados para Kindle.
 ...
 2. **La Forja**: Usa Kindle Comic Converter (KCC) para optimizar imágenes para pantallas e-ink.
 3. **El Correo**: Entrega el archivo final a tu destino preferido.
