...
def _deliver_via_telegram(mobi_file: str, params: PipelineParams) -> None:
...
def _deliver_via_r2(mobi_file: str, params: PipelineParams) -> None:
    manga, vol = format_manga_title(mobi_file, OUTPUT_FOLDER_KCC)
    ...
    _deliver_via_telegram(mobi_file, params)
...
def deliver_files(
    ...
    if params.r2:
        for mobi_file in mobi_files:
            _deliver_via_r2(mobi_file, params)
        return
